...
var rootCmd = &cobra.Command{
	Use:           "mello",
	Short:         "Mello CLI — kanban management + local agent runtime",
...
func init() {
	...
	rootCmd.SetVersionTemplate("mello {{.Version}}\n")
	...
	rootCmd.PersistentFlags().BoolVar(&debugFlag, "debug", false, "Print full error details on failure (env: MELLO_DEBUG)")
...
func profile() string {
	...
	return os.Getenv("MELLO_PROFILE")
}
