...
## Task [1]: SQLite schema migrations  (tags: db, backend, migration) — done
...
## Task [2]: SQLite Store implementation  (tags: db, backend) — done
...
## Task [3]: SQLite Store conformance tests  (tags: test, db) — done
...
## Task [4]: Store NewStore() scheme dispatch  (tags: backend, config) — done
...
## Task [5]: Run-server helper  (tags: cli, backend) — done
...
## Task [6]: Wait-for-readyz + enroll  (tags: cli, api, auth) — done
...
## Task [7]: Run-worker helper  (tags: cli, backend, infra) — done
...
## Task [8]: Stack lifecycle  (tags: cli, infra) — done
...
## Task [9]: Daemon `--offline --with-mezon` plumbing  (tags: cli) — done
...
## Task [10]: `mework init --provider mezon`  (tags: cli, docs) — done
...
## Task [12]: Stack-level integration test  (tags: test, cli, backend) — done
...
## Task [13]: Provider credential store compatibility  (tags: cli, config) — done
...
## Task checklist (ticked as units ship)
...
- [x] Task [12]
- [x] Task [13]
- [x] Task [11] (unit 04 — docs)
- [x] Task [14] (unit 04 — docs)
