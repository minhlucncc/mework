...
Define the multi-tenant isolation model for the hub: tenants as isolated
boundaries, cross-tenant access denial, and tenant-scoped registration tokens
that bind runner identities to a single tenant.
